...
/**
 * 类FormatValidator.java的实现描述：TODO 类实现描述 
 * @author cdtangping 2014-8-27 下午12:38:56
 */
...
public class FormatValidator
{
    ...
    {
        boolean flag = false;
        Pattern p = Pattern.compile("^[A-Za-z\u4E00-\u9FA5\\d\\s\\.]*$");
        if (str != null)
        {
            Matcher match = p.matcher(str);
            flag = match.matches();
...
//        Pattern p = Pattern.compile("^1\\d{10}$");
    ...
    public static void main(String[] args){
        boolean flag = FormatValidator.isValidMobileNo("17085699658");
